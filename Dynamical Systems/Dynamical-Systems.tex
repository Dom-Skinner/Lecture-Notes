...
$\frac{\partial^2 f}{\partial x \partial \mu} \neq 0$. We can get round this
...
$y= \frac{1}{\lambda} \frac{\partial g}{\partial \mu} \mu $ (with $E^s$ the line
$x=\mu=0$) and the extended centre manifold is a surface $y = h(x,\mu)$ with
$h = \pder{h}{x} =0$, $\pder{h}{\mu} = \frac{1}{\lambda} \pder{g}{\mu}$ at 
$x=\mu=0$.
\\
\\
...
From $\dot{y} = \frac{dy}{dx}\dot{x} +0$ get that
